        ...
        <div class="wizard">
          <div class="wizard-inner">
            ...
            <ul class="nav step-tabs" role="tablist">
              ...
              <li role="presentation" class="disabled">
                <a href="#step4" data-toggle="tab" aria-controls="step4" role="tab"><span class="round-tab">4</span>
                  <i>Step 4</i></a>
              </li>
            </ul>
          </div>
              ...
              <div class="tab-pane" role="tabpanel" id="step4">
                ...
                <div class="all-info-container">
                  <div class="list-content">
                    <a href="#listone" data-toggle="collapse" aria-expanded="false" aria-controls="listone">Collapse 1
                  ...
                  <div class="list-content">
                    <a href="#listtwo" data-toggle="collapse" aria-expanded="false" aria-controls="listtwo">Collapse 2
                      <i class="fa fa-chevron-down"></i></a>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select name="legalform2" class="form-control" id="legalform2" disabled="disabled">
                                ...
                                <option value="GbR">No minimum capital, unlimited liability of partners, non-busines
                                </option>
                              </select>
                            </div>
                          </div>
                  ...
                  <div class="list-content">
                    <a href="#listthree" data-toggle="collapse" aria-expanded="false" aria-controls="listthree">Collapse
...
.wizard .step-tabs>li.active>a,
.wizard .step-tabs>li.active>a:hover,
.wizard .step-tabs>li.active>a:focus {
  color: #555555;
  cursor: default;
  border: 0;
  border-bottom-color: transparent;
...
.wizard .step-tabs>li.active>a i {
  color: #0db02b;
}
...
$(document).ready(function () {
    ...
    $(".next-step").click(function (e) {
        ...
        var active = $('.wizard .step-tabs li.active');
...
$('.step-tabs').on('click', 'li', function() {
    $('.step-tabs li.active').removeClass('active');
